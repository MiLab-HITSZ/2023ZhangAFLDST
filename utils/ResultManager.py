...
WINDOWS_RESULT_PATH = "C:/Users/4444/PycharmProjects/Multi_server_federated_learning/results/2022_11/"
# WINDOWS_RESULT_PATH = "C:/Users/4444/PycharmProjects/Multi_server_federated_learning/results/paper_imgs/"
LINUX_RESULT_PATH = "/home/zrz/codes/Multi_server_federated_learning/results/2022_11/"
...
def handle_result(file_name, epochs, curve_num, curve_name_list, accuracy_lists, loss_lists):
    ...
    if platform.system().lower() == 'windows':
        file_path = WINDOWS_RESULT_PATH + file_name + ".txt "
        ...
        file_path = LINUX_RESULT_PATH + file_name + ".txt"
        save_result_to_txt(file_path, epochs, curve_num, curve_name_list, accuracy_lists, loss_lists)
...
def draw_curves(epochs, curve_num, curve_name_list, accuracy_lists, loss_lists):
    ...
    if len(accuracy_lists) > 0:
        ...
        plt.legend(accuracy_curve_names, fontsize=16)
...
def draw_curves_from_txt(file_name):
    ...
    #               'r')
    r_file = open(WINDOWS_RESULT_PATH + str(file_name), "r")
    # r_file = open('C:/Users/4444/PycharmProjects/Multi_server_federated_learning/results/paper_imgs/'
    #               + str(file_name), 'r')
    # 读取epochs
    for line in r_file:
        if line == '\n':
    ...
    first_index_list = find_first_target_in_lists(0.3, accuracy_lists)
