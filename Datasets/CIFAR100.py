...
class CIFAR100:
    def __init__(self):
        (x, y), (x_test, y_test) = datasets.cifar100.load_data()  # 加载 CIFAR10 数据集
        self.train_data = [x, y]
        self.pre_valid_data = [x_test[0: 500], y_test[0: 500]]
        self.valid_data = [x_test[500: 5000], y_test[500: 5000]]
    ...
    def get_sorted_dataset(self):
        ...
        sorted_cifar100_x, sorted_cifar100_y = Tools.generate_sorted_dataset(x, y, 50000)
        return sorted_cifar100_x, sorted_cifar100_y
